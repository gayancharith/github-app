	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                this.props.bio.avatar_url && React.createElement(
	                    ...
	                    React.createElement("img", { src: this.props.bio.avatar_url, className: "avatarImage" })
	                ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
	    getGithubInfo: function getGithubInfo(username) {
	        return _axios2['default'].all([getRepos(username), getUserDetails(username)]).then(function (arr) {
	            return {
	                repos: arr[0].data,
	                bio: arr[1].data
	            };
